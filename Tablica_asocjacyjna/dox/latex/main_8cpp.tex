...
{\ttfamily \#include \char`\"{}tablica\-\_\-asocjacyjna\-\_\-db.\-hh\char`\"{}}\*
...
\begin{DoxyCompactList}\small\item\em \-Prezentuje działanie tablicy. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\-Jest to glowna funkcja programu odpowiedzialna za wprowadzenie przykładowych danych do tablicy oraz demonstrację działania niektórych jego funkcji. 
